...
[^2]: You can use the combine_style() function to override styles. You specify the text_style objects, then the priority argument. Priority can be set to first, last, or 'error' to match the behavior of `+`.
